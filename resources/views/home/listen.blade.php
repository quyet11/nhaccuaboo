...
<html>
   <head>
    ...
    <base href="/public">
      ...
      <link rel='stylesheet' href='https://rsms.me/inter/inter.css'><link rel="stylesheet" href="home/css/style1.css">
<style>
    .haha{
        height: 150px;
        width: 150px;
   ...
   <body>
      ...
      <body  class="">
        ...
        <style>
            /* Thêm vào phần CSS để điều chỉnh chiều rộng của thẻ audio */
            .audio {
                width: 500p; /* Đặt chiều rộng là 100% của phần tử chứa nó */
                max-width: 300px; /* Có thể thay đổi giá trị này tùy theo ý muốn */
            }
        </style>
		<div class="bg-[#F8FAFC] dark:bg-[#0A1122] w-screen h-screen flex flex-col items-center justify-center">
			<div class="relative w-player flex flex-col rounded-xl shadow-player-light bg-player-light-background border border-player-light-border dark:shadow-player-dark dark:bg-player-dark-background dark:border-player-dark-border dark:backdrop-blur-xl">
                <div class="px-10 pt-10 pb-4 flex items-center z-50">
                    <img class="haha" src="music/{{$music->image}}" alt="">

                    <div class="flex flex-col ml-4"> <!-- Thêm class "ml-4" để tạo khoảng cách giữa ảnh và thông tin -->
                        <h1><b>Name:  {{$music->title}}</b></h1>
                        <b>Artist:  {{$music->artist}}</b>
                        <b>Genre:  {{$music->genre}}</b>
                    </div>
                </div>

                <!-- Di chuyển thẻ audio xuống đây -->
      ...
      <script src='https://cdn.jsdelivr.net/npm/amplitudejs@5.2.0/dist/amplitude.js'></script><script  src="home/js/script.js"></script>
   </body>
</html>
